...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_example_kmpoh_Greeting;
typedef struct {
  libkn_KNativePtr pinned;
        ...
        struct {
          struct {
            struct {
              ...
              libkn_kref_com_example_kmpoh_Greeting (*Greeting)();
              const char* (*greet)(libkn_kref_com_example_kmpoh_Greeting thiz);
            } Greeting;
            struct {
              libkn_KType* (*_type)(void);
            ...
            libkn_KInt (*com_example_kmpoh_Greeting$stableprop_getter)();
            libkn_KInt (*com_example_kmpoh_OhosPlatform$stableprop_getter)();
            libkn_KInt (*com_example_kmpoh_Greeting$stableprop_getter_)();
            libkn_KInt (*com_example_kmpoh_OhosPlatform$stableprop_getter_)();
            libkn_KInt (*com_example_kmpoh_Greeting$stableprop_getter__)();
            libkn_KInt (*com_example_kmpoh_OhosPlatform$stableprop_getter__)();
            void* (*MainArkUIViewController_)(void* env);
            libkn_KInt (*com_example_kmpoh_Greeting$stableprop_getter___)();
            libkn_KInt (*com_example_kmpoh_OhosPlatform$stableprop_getter___)();
            libkn_KInt (*com_example_kmpoh_Greeting$stableprop_getter____)();
            libkn_KInt (*com_example_kmpoh_OhosPlatform$stableprop_getter____)();
